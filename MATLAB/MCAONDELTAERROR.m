filename2MCE1 = '..\MC\cmake-build-debug\MCAONDELTAERR000.txt';
filename2MCE2 = '..\MC\cmake-build-debug\MCAONDELTAERR001.txt';
filename2MCE3 = '..\MC\cmake-build-debug\MCAONDELTAERR002.txt';
filename2MCE4 = '..\MC\cmake-build-debug\MCAONDELTAERR003.txt';
delimiterIn = ' ';
headerlinesIn = 1;
...
xlabel("Mean")
ylabel("Density")
title('Asset-Or-Nothing - Monte Carlo Error Convergence')
